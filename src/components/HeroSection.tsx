        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-8 fade-in">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight animate-in slide-in-from-bottom-5 duration-700">
                {t('hero.title.line1')}
                <span className="gradient-text block">{t('hero.title.line2')}</span>
              </h1>
              
              {/* Dynamic Feature Showcase */}
              <div className="flex items-center justify-center gap-2 md:gap-4 p-4 glass rounded-2xl max-w-xs md:max-w-md mx-auto">
